...
def test_url_discovery_file():
    urlOut = UrlDiscoEngine(True,10).run_url_discovery('file:///Users/joeyd/Documents/JoeyDCareer/GitHub/MasteringSpacy/Spacy_Tutorials/ner_food_ingredients/assets/test/html/html_test_0.html', 'file:', explodeTimes = 1, saveOut=None)
    print(urlOut)
    return urlOut
